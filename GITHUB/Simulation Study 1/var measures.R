 ...
 # RRMSE_sd=c(mean((dfsd[,1]-SD[1])^2/SD[1]^2),
 #          mean((dfsd[,2]-SD[2])^2/SD[2]^2),
 #          mean((dfsd[,3]-SD[3])^2/SD[3]^2))^(1/2) #RRMSE (Li et al, 2025)
 ...
 RRMSE1_sd=c(mean((esd1_RDS[,1]-SD[1])^2/SD[1]^2),
            ...
            mean((esd_np[,3]-SD[6])^2/SD[6]^2))^(1/2) #RRMSE (Li et al, 2025)
