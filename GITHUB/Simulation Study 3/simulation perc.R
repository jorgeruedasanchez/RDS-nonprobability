...
nombre_image = paste0("resultsperc_rev.RData")
save.image(file = nombre_image)

outfile <- paste0("resultsperc_rev.RDataTmp")
...
CIS_IPW=mean(est$PSA1+z*sqrt(dfvar$vanal_ipw)) #IPW: 8.472655-8.800419
CIS_MI=mean(est$SM+z*sqrt(dfvar$vanal_mi)) #MI: 8.406087-8.853362
CIS_DR=mean(est$DR+z*sqrt(dfvar$vanal_dr)) #DR: 8.474033-8.785454
#Theta_mean=8.6474