...
est_PSA2 <- meanest("feliz", sv, sc_weights(propensidades$convenience))
est_PSA3 <- meanest("feliz", sv, lee_weights(propensidades$convenience, propensidades$reference))
est_PSA4 <- meanest("feliz", sv, vd_weights(propensidades$convenience, propensidades$reference))
...
wi_KW <- kw.wt(p_score.c = propensidades$convenience, p_score.s = propensidades$reference,
               svy.wt = di)
est_KW <- meanest("feliz", sv, wi_KW$pswt)
