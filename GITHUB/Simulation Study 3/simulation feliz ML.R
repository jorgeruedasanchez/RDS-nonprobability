...
#DR
est_DR_nnet <- sum((sv$feliz - y_matching_sv_nnet)/propensidades_nnet$convenience)/nrow(pob) + est_SM_nnet
...
nnet_feliz=data.frame(RBias_nnet, RSD_nnet, RMSE_nnet)
