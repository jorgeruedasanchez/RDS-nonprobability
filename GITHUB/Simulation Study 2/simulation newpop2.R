set.seed(1)
setwd(paste0("C:/Users/jorge/Desktop/EST/TI/2024-2025 (2º Año Doctorado)/Artículos/Artículo Ismael/Escenario Inicial (estudio simul art)/Nuevas redes/", escenario))
...
for(i in 1:rep){
  ...
  source("C:/Users/jorge/Desktop/EST/TI/2024-2025 (2º Año Doctorado)/Artículos/Artículo Ismael/Escenario Inicial (estudio simul art)/Nuevas redes/script_sim.R")
