setwd("H:/Otros ordenadores/Mi portátil/EST/TI/2024-2025 (2º Año Doctorado)/Artículos/Artículo Ismael/Escenario Inicial (estudio simul art)/datos")
...
for(i in 461:rep){
  ...
  source("H:/Otros ordenadores/Mi portátil/EST/TI/2024-2025 (2º Año Doctorado)/Artículos/Artículo Ismael/Escenario Inicial (estudio simul art)/script_sim.R")
  ...
  nombre_image = paste0("results_rev.RData")
  save.image(file = nombre_image)
  
  outfile <- paste0("results_rev.RDataTmp")
